...
from tensorpack.models import FullyConnected, layer_register, Conv2D
from tensorpack.tfutils.scope_utils import under_name_scope
from tensorpack.tfutils.summary import add_moving_summary
from tensorpack.utils.argtools import memoized_method

from tracker.config import config as cfg
from tracker.model.siam import base_model, box_model
...
def sample_fast_rcnn_targets(boxes, gt_boxes, gt_labels):
    ...
    """
    iou = box_ops.pairwise_iou(boxes, gt_boxes)  # nxm
...
class FastRCNNHead(object):
    ...
    @memoized_method
    def losses(self):
        encoded_fg_gt_boxes = box_model.encode_bbox_target(
    ...
    def decoded_output_boxes(self):
        ...
        decoded_boxes = box_model.decode_bbox_target(
    ...
    def decoded_output_boxes_for_label(self, labels):
        ...
        decoded = box_model.decode_bbox_target(
...
def fastrcnn_Xconv1fc_head(feature, num_convs, norm=None):
    ...
    with argscope(Conv2D, data_format='channels_first',
        ...
        for k in range(num_convs):
            ...
            if norm is not None:
                l = base_model.GroupNorm('gn{}'.format(k), l)
...
def fastrcnn_predictions(boxes, scores):
    ...
    def f(X):
        ...
        if common_util.get_tf_version_tuple() >= (1, 13):
    ...
    # TF bug in version 1.11, 1.12: https://github.com/tensorflow/tensorflow/issues/22750 ## TODO CHECK
    buggy_tf = common_util.get_tf_version_tuple() in [(1, 11), (1, 12)]
