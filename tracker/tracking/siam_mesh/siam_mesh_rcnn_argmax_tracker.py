...
from tracker.model.siam_mesh.siam_mesh_rcnn_model import ResNetFPNMeshModel, MeshTrackModel
...
class PrecomputingReferenceTracker(Tracker):
    def __init__(self, name, need_network=True, need_img=True, model="best", conv_mode='spiral'):
        ...
        if need_network:
            ...
            extract_model = ResNetFPNMeshModel(mesh_path=cfg.COMA.TEMPLATE_MESH_TRACKER,
                                               fpn_conv_mode=conv_mode,
                                               coma_conv_mode=conv_mode)
