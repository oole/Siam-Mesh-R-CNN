...
from tracker.model.siam_mesh.siam_mesh_rcnn_model import MeshTrackModel
from tracker.tracking.siam_mesh.siam_mesh_rcnn_argmax_tracker import PrecomputingReferenceTracker
...
class ThreeStageConvTracker(PrecomputingReferenceTracker):
    ...
    def _make_pred_func(self, load):
        ...
        pred_model = MeshTrackModel(mesh_path=cfg.COMA.TEMPLATE_MESH_TRACKER,
                                    fpn_conv_mode=self.conv_mode, coma_conv_mode=self.conv_mode)
