...
from tracker.tracking.siam.argmax_tracker import PrecomputingReferenceTracker
...
class ThreeStageTracker(PrecomputingReferenceTracker):
    ...
    def _make_pred_func(self, load):
        ...
        from tracker.model.siam.track_model import ResNetFPNTrackModel
    ...
    if VIZ_WITH_OPENCV:
        ...
        def _viz_result(self, box):
            ...
            cv2.rectangle(self._cv_img, (int(box[0]), int(box[1])), (int(box[2]), int(box[3])), (0, 252, 124), 6)
