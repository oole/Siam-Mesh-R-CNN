...
from tracker.tracking.fpn_conv.fpn2mesh_conv_argmax_tracker import ArgmaxConvTracker
from tracker.tracking.fpn_conv.fpn2mesh_conv_three_stage_tracker import ThreeStageConvTracker
...
def build_tracker():
    if args.tracker == "ArgmaxTracker":
        name = "FPN2Mesh-" + args.tracker + "-" + args.model
        if args.path_to_model is not None:
            os.path.basename(args.path_to_model)
    ...
    name = "FPN2Mesh-ThreeStageTracker_" + param_str
