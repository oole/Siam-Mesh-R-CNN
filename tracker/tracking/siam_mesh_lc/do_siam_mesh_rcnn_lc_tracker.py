...
from tracker.tracking.siam_mesh_lc.siam_mesh_rcnn_argmax_lc_tracker import ArgmaxConvTracker
from tracker.tracking.siam_mesh_lc.siam_mesh_rcnn_three_stage_lc_tracker import ThreeStageConvTracker
import os
...
parser.add_argument('--model', type=str, default="oole-resnet50-lc_conv",
...
def main_chokepoint():
    ...
    experiment = exp.ExperimentChokepoint(
        name="siam_mesh_rcnn_lc-" + args.name,
