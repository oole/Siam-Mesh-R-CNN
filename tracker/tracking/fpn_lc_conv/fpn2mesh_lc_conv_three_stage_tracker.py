...
from tracker.tracking.fpn_lc_conv.fpn2mesh_lc_conv_argmax_tracker import PrecomputingReferenceTracker
from tracker.model.leftovers.lc_fpn2mesh_conv_track_model import ConvTrackModel
...
class ThreeStageConvTracker(PrecomputingReferenceTracker):
    def __init__(self, tracklet_distance_threshold=0.06, tracklet_merging_threshold=0.3,
                 ...
                 name="ThreeStageTracker", model="best", n_proposals=None, resolution=None, path_to_model=None):
        """
        ...
        super().__init__(name=name, need_network=True, need_img=True, model=model, path_to_model=path_to_model)
    ...
    def _update_tracklets(self, img):
        ...
        tracklet_score_indices = self._pred_func(
                resized_img, self._ff_gt_feats, self._ff_gt_mesh_feats, self._ff_gt_tracklet.feats[-1],  active_tracklets_feats,
