...
from tracker.model.leftovers.lc_fpn2mesh_conv_track_model import ResNetFPNConvModel, ConvTrackModel
...
class PrecomputingReferenceTracker(Tracker):
    def __init__(self, name, need_network=True, need_img=True, model="best", path_to_model=None):
        ...
        if need_network:
            ...
            elif model == "oole-resnet50-fpn2mesh_lc":
                load = (
                    "/home/oole/conv-track/model-dir/tp_lc_fpn2mesh_conv_track-220201-2216/model-70000")
                cfg.BACKBONE.RESNET_NUM_BLOCKS = [3, 4, 6, 3]
            else:
