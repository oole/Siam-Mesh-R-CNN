...
import argparse
from tracker.tracking.lc_conv.lc_conv_three_stage_tracker import ThreeStageConvTracker
from tracker.tracking.lc_conv.lc_conv_argmax_tracker import ArgmaxConvTracker
...
parser.add_argument('--model', type=str, default="oole-resnet50-lc_conv", help='one of "best", "nohardexamples", or "gotonly"')
parser.add_argument('--tracker', type=str, default='ThreeStageTracker', help="One of ArgmaxTracker or ThreeStageTracker")
...
def build_tracker():
    if args.tracker == "ArgmaxTracker":
        return ArgmaxConvTracker(model=args.model, name=args.tracker + args.model)
