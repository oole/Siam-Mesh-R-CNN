...
from tracker.model.leftovers.lc_conv_track_model import ResNetFPNConvModel
...
class PrecomputingReferenceTracker(Tracker):
    def __init__(self, name, need_network=True, need_img=True, model="best"):
        ...
        if need_network:
            ...
            if model == "oole-resnet50-lc_conv":
                load = (
                    "/home/oole/lc_conv-track/model-dir/partial_tp_conv-track_img2mesh2feature-lc_220130-0153/model-110000")
