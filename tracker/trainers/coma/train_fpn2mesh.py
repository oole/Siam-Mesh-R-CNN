...
if __name__ == "__main__":
    ...
    parser.add_argument('--logdir', help='log directory',
                        default='../computed/coma/test_with_other_mean_std')
    ...
    choke_dataflow_provider = data.ChokepointDataflowProvider(mesh_path=cfg.COMA.TEMPLATE_MESH_TRACKER)
    ...
    if args.loss == 'edge':
        coma_model = feature_mesh_model.FeatureToMeshComa(edge_vertices=choke_dataflow_provider.edge_vertices,
                                                          ...
                                                          mesh_path=cfg.COMA.TEMPLATE_MESH_TRACKER)
    elif args.loss == 'l1-only':
        coma_model = feature_mesh_model.FeatureToMeshComa(conv_mode=args.conv_mode,
                                                          mesh_path=cfg.COMA.TEMPLATE_MESH_TRACKER)
    else:
