...
from tracker.model.siam_mesh import siam_mesh_rcnn_model
...
if __name__ == "__main__":
    ...
    parser.add_argument('--logdir', help='log directory', default='../../computed/siam_mesh_rcnn')
    ...
    tracker_model = siam_mesh_rcnn_model.MeshTrackModel(mesh_path=cfg.COMA.TEMPLATE_MESH_TRACKER,
