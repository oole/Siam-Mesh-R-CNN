...
from tracker.model.leftovers import lc_fpn2mesh_conv_track_model
...
if __name__ == "__main__":
    ...
    parser.add_argument('--logdir', help='log directory', default='../computed/test_lc_fpn2mesh_model_1')
    ...
    tracker_model = lc_fpn2mesh_conv_track_model.ConvTrackModel()
