...
from tracker.model.leftovers import fpn2mesh_conv_track_model
...
if __name__ == "__main__":
    ...
    parser.add_argument('--logdir', help='log directory', default='../computed/test_fpn2mesh_model_1')
    ...
    tracker_model = fpn2mesh_conv_track_model.ConvTrackModel()
